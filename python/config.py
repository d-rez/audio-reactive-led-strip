...
CHROMA_TKL_KEYBOARD = True # TenKeyless, and for laptops
CHROMA_VISTYPE_SCALED = False # Enabling will use another function which scales Chroma efffects. Try both I guess
DEVICES_ENABLED = { "LED_STRIP2": False,
                    "CHROMA": True,
                    "LIFX": True
}
